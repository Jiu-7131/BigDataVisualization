...
ANALYSIS_NOTES = {
    ...
    5:  "用平行坐标展示各行业在估值、动量、质量、波动率等多因子维度上的综合得分轮廓，支持拖拽刷选筛选行业。",
    5:  "用平行坐标展示各行业在估值、动量、质量、波动率等多因子维度上的综合得分轮廓，支持拖拽刷选筛选行业。",
    6:  "将行业超额收益拆解为各因子的贡献，绿色柱=正向贡献、红色柱=负向贡献，直观展示收益来源结构。",
    7:  "监控四大因子的拥挤程度，指针进入红色区表示过度拥挤、因子可能失效，辅助判断是否应回避该因子。",
    8:  "对比不同经济周期阶段下各行业的收益率分布，识别各阶段的优势行业（如复苏期周期行业、衰退期防御行业）。",
